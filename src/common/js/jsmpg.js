...
Jsmpeg.prototype.decodeSocketHeader = function( data ) {
  // Custom header sent to all newly connected clients when streaming over websockets:
...
Jsmpeg.prototype.receiveSocketMessage = function( event ) {
  ...
  console.log("decodeSocketHeader")
  }
//console.log("current")
...
console.log("BitReader.NOT_FOUND")
      return
    }
...
Jsmpeg.prototype.fillArray = function fillArray(a, value) {
